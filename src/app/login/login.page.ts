...
export class LoginPage implements OnInit {
  ...
  constructor(private router: Router,private animationCtrl: AnimationController, private auth:AuthGuard, private api:ApiService, private alertController :AlertController) { }
  ...
  apiLogin() {
    this.api.login(this.usuario.value.username!, this.usuario.value.password!).subscribe(
      (response) => {
